...
var DoES = (function() {
    ...
    var last_explosion = new Date('2022/12/08 18:73');
    var last_flood = new Date('2018/09/28 16:30');
    ...
    function updateCalendar(cal) {
        ...
        calendar_script.setAttribute('src','http://wiki.doesliverpool.com/does-api/calendar.php?callback=DoES.calendarCallback&cal='+encodeURIComponent(cal)+'&cb='+Math.random());
