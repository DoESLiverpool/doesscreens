...
} else if ($_REQUEST['cal'] == 'biglaser') {
    $json = json_encode(file_get_contents('http://www.google.com/calendar/ical/doesliverpool.com_3a7t1mug53qbloackgno6u2mqk%40group.calendar.google.com/private-3ecd990c1dcdc970785ac58377a553d2/basic.ics'));
} else if ($_REQUEST['cal'] == 'smalllaser' || $_REQUEST['cal'] == 'smalllaser') {
